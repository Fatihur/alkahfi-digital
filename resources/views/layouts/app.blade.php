            ...
            <div class="navbar-actions">
                ...
                <div class="user-dropdown">
                    <button class="user-dropdown-toggle" onclick="toggleUserDropdown()">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=eef2ff&color=4f46e5&size=32" alt="User" class="user-dropdown-avatar">
                        <span class="user-dropdown-name">{{ auth()->user()->name }}</span>
                        <i class="bi bi-chevron-down"></i>
                    </button>
                    <div class="user-dropdown-menu" id="userDropdownMenu">
                        <div class="user-dropdown-header">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=eef2ff&color=4f46e5&size=48" alt="User" class="user-dropdown-header-avatar">
                            <div class="user-dropdown-header-info">
                                <div class="user-dropdown-header-name">{{ auth()->user()->name }}</div>
                                <div class="user-dropdown-header-role">{{ ucfirst(str_replace('_', ' ', auth()->user()->role)) }}</div>
                            </div>
                        </div>
