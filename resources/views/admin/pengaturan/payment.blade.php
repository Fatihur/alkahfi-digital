...
@section('content')
    ...
    <div class="row">
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.pengaturan.payment.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label class="form-check">
                                ...
                                <input type="checkbox" name="payment_gateway_enabled" value="1" class="form-check-input" {{ $settings['payment_gateway_enabled'] == '1' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="duitku_merchant_code" class="form-control" value="{{ $settings['duitku_merchant_code'] }}" placeholder="Masukkan Merchant Code">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div style="position: relative;">
                                        <input type="password" name="duitku_api_key" id="apiKeyInput" class="form-control" value="{{ $settings['duitku_api_key'] }}" placeholder="Masukkan API Key">
                        ...
                        <div class="form-group">
                            ...
                            <select name="duitku_is_production" class="form-control form-select">
                                <option value="0" {{ $settings['duitku_is_production'] == '0' ? 'selected' : '' }}>Sandbox (Testing)</option>
                                <option value="1" {{ $settings['duitku_is_production'] == '1' ? 'selected' : '' }}>Production (Live)</option>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="duitku_callback_url" class="form-control" value="{{ $settings['duitku_callback_url'] ?: url('/api/duitku/callback') }}" placeholder="{{ url('/api/duitku/callback') }}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="duitku_return_url" class="form-control" value="{{ $settings['duitku_return_url'] ?: url('/wali/pembayaran') }}" placeholder="{{ url('/wali/pembayaran') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="duitku_expiry_period" class="form-control" value="{{ $settings['duitku_expiry_period'] }}" min="60" max="10080">
    ...
    <script>
        ...
        function testConnection() {
            ...
            fetch('{{ route("admin.pengaturan.payment.test") }}', {
                method: 'POST',
                headers: {
