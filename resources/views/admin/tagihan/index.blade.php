                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('admin.tagihan.show', $t) }}" class="btn btn-sm btn-secondary"><i class="bi bi-eye"></i></a>
                                    @if($t->status !== 'lunas')
                                        <a href="{{ route('admin.tagihan.edit', $t) }}" class="btn btn-sm btn-secondary"><i class="bi bi-pencil"></i></a>
                                        <form action="{{ route('admin.tagihan.destroy', $t) }}" method="POST" onsubmit="return confirm('Yakin?')">
                                            @csrf @method('DELETE')
