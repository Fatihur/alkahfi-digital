    ...
    <div class="page-header">
        ...
        <div class="d-flex gap-2">
            @if($pembayaran->status === 'berhasil')
                <a href="{{ route('bendahara.pembayaran.cetak', $pembayaran) }}" class="btn btn-secondary" target="_blank"><i class="bi bi-printer"></i> Cetak</a>
            @endif
            <a href="{{ route('bendahara.pembayaran.index') }}" class="btn btn-secondary">Kembali</a>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr><td><strong>Metode</strong></td><td>{{ ucfirst($pembayaran->metode_pembayaran) }}</td></tr>
