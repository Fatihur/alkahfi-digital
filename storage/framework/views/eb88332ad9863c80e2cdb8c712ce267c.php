...
<?php $__env->startSection('content'); ?>
    <div class="page-header">
        ...
        <div>
            <a href="<?php echo e(route('bendahara.pembayaran.create')); ?>" class="btn btn-primary">
                ...
                <tbody>
                    <?php $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('bendahara.pembayaran.show', $p)); ?>" class="btn btn-sm btn-info" title="Detail">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <?php if($p->status === 'berhasil'): ?>
                                        <a href="<?php echo e(route('bendahara.pembayaran.cetak', $p)); ?>" class="btn btn-sm btn-secondary" target="_blank" title="Cetak">
...
<?php echo $__env->make('layouts.bendahara', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ORDER\MASTARI\E-SPP\alkahfi-digital\resources\views/bendahara/pembayaran/index.blade.php ENDPATH**/ ?>