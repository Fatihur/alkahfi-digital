<?php $__env->startSection('title', 'Kontak - ' . ($profil->nama_sekolah ?? 'Sekolah')); ?>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0"><?php echo e($profil->alamat); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0"><a href="tel:<?php echo e($profil->telepon); ?>" class="text-dark text-decoration-none"><?php echo e($profil->telepon); ?></a></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0"><a href="mailto:<?php echo e($profil->email); ?>" class="text-dark text-decoration-none"><?php echo e($profil->email); ?></a></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0"><a href="<?php echo e($profil->website); ?>" target="_blank" class="text-dark text-decoration-none"><?php echo e($profil->website); ?></a></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex pt-3">
                        <?php if($profil->sosial_media['facebook'] ?? false): ?>
                            <a class="btn btn-square btn-primary me-2" href="<?php echo e($profil->sosial_media['facebook']); ?>" target="_blank"><i class="fab fa-facebook-f"></i></a>
                        <?php endif; ?>
                        <?php if($profil->sosial_media['instagram'] ?? false): ?>
                            <a class="btn btn-square btn-primary me-2" href="<?php echo e($profil->sosial_media['instagram']); ?>" target="_blank"><i class="fab fa-instagram"></i></a>
                        <?php endif; ?>
                        <?php if($profil->sosial_media['youtube'] ?? false): ?>
                            <a class="btn btn-square btn-primary me-2" href="<?php echo e($profil->sosial_media['youtube']); ?>" target="_blank"><i class="fab fa-youtube"></i></a>
                        <?php endif; ?>
                        <?php if($profil->sosial_media['twitter'] ?? false): ?>
                            <a class="btn btn-square btn-primary" href="<?php echo e($profil->sosial_media['twitter']); ?>" target="_blank"><i class="fab fa-twitter"></i></a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-lg-8 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <?php if($profil->maps_embed ?? false): ?>
                        <div class="position-relative rounded overflow-hidden w-100" style="min-height: 400px;">
                            <?php echo $profil->maps_embed; ?>

                        </div>
                    <?php elseif($profil->foto_gedung ?? false): ?>
                        <img class="img-fluid rounded w-100" src="<?php echo e(Storage::url($profil->foto_gedung)); ?>" alt="Gedung Sekolah" style="min-height: 400px; object-fit: cover;">
                    <?php else: ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ORDER\MASTARI\E-SPP\alkahfi-digital\resources\views/landing/kontak.blade.php ENDPATH**/ ?>