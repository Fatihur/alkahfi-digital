        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body" style="text-align: center; padding: 40px;">
                    ...
                    <a href="<?php echo e(route('admin.laporan.transaksi')); ?>" class="btn btn-primary">Lihat Laporan</a>
                </div>
            </div>
        </div>
        <div class="col-4">
            <div class="card">
                <div class="card-body" style="text-align: center; padding: 40px;">
                    ...
                    <a href="<?php echo e(route('admin.laporan.tunggakan')); ?>" class="btn btn-primary">Lihat Laporan</a>
                </div>
            </div>
        </div>
        <div class="col-4">
            <div class="card">
                <div class="card-body" style="text-align: center; padding: 40px;">
                    ...
                    <a href="<?php echo e(route('admin.laporan.rekapitulasi')); ?>" class="btn btn-primary">Lihat Laporan</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ORDER\MASTARI\E-SPP\alkahfi-digital\resources\views/admin/laporan/index.blade.php ENDPATH**/ ?>