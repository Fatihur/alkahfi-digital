...
<head>
    ...
    <?php if(config('midtrans.is_production')): ?>
        <script src="https://app.midtrans.com/snap/snap.js" data-client-key="<?php echo e($clientKey); ?>"></script>
    <?php else: ?>
        <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="<?php echo e($clientKey); ?>"></script>
    <?php endif; ?>
</head>
    ...
    <div style="max-width: 500px; margin: 50px auto; padding: 20px;">
        <div class="card">
            <div class="card-body" style="padding: 40px; text-align: center;">
                ...
                <p class="text-muted"><?php echo e($pembayaran->tagihan->nama_tagihan); ?></p>
                ...
                <div style="background: var(--bg-body); padding: 20px; border-radius: 8px; margin: 20px 0;">
                    <table class="table" style="margin: 0; text-align: left;">
                        <tr>
                            <td>Santri</td>
                            <td style="text-align: right;"><strong><?php echo e($pembayaran->santri->nama_lengkap); ?></strong></td>
                        </tr>
                        <tr>
                            <td>NIS</td>
                            <td style="text-align: right;"><?php echo e($pembayaran->santri->nis); ?></td>
                        </tr>
                        <tr>
                            <td>No. Transaksi</td>
                            <td style="text-align: right;"><code><?php echo e($pembayaran->nomor_transaksi); ?></code></td>
                        </tr>
                    </table>
                </div>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('wali.tagihan.index')); ?>" class="btn btn-secondary">Kembali</a>
                <?php endif; ?>

                <div style="margin-top: 20px;">
                    <a href="<?php echo e(route('wali.pembayaran.index')); ?>" class="btn btn-secondary">
        ...
        document.getElementById('pay-button').addEventListener('click', function() {
            snap.pay('<?php echo e($snapToken); ?>', {
                onSuccess: function(result) {
                    fetch('<?php echo e(route("wali.pembayaran.verify", $pembayaran->id)); ?>', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        window.location.href = '<?php echo e(route("wali.pembayaran.index")); ?>?status=success';
                    })
                    .catch(error => {
                        window.location.href = '<?php echo e(route("wali.pembayaran.index")); ?>?status=success';
                    });
                ...
                onPending: function(result) {
                    window.location.href = '<?php echo e(route("wali.pembayaran.index")); ?>?status=pending';
                },
                onError: function(result) {
                    window.location.href = '<?php echo e(route("wali.pembayaran.index")); ?>?status=error';
                },
                onClose: function() {
...
<?php /**PATH D:\ORDER\MASTARI\E-SPP\alkahfi-digital\resources\views/wali/pembayaran/checkout.blade.php ENDPATH**/ ?>