    ...
    <div class="info">
        <table>
            <tr>
                ...
                <td>: <?php echo e($tanggalDari); ?> s/d <?php echo e($tanggalSampai); ?></td>
            </tr>
            <tr>
                <td class="label">Jumlah Transaksi</td>
                <td>: <?php echo e($pembayaran->count()); ?> transaksi</td>
            </tr>
        </table>
    </div>
    ...
    <table class="data">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e($p->nomor_transaksi); ?></td>
                    <td><?php echo e($p->santri->nama_lengkap); ?></td>
                    <td><?php echo e($p->santri->nis); ?></td>
                    <td><?php echo e($p->tagihan->nama_tagihan); ?></td>
                    <td class="text-right">Rp <?php echo e(number_format($p->jumlah_bayar, 0, ',', '.')); ?></td>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right">Rp <?php echo e(number_format($totalPembayaran, 0, ',', '.')); ?></td>
                <td colspan="2"></td>
            </tr>
        </tfoot>
    </table>
...
</html><?php /**PATH D:\ORDER\MASTARI\E-SPP\alkahfi-digital\resources\views/bendahara/laporan/pdf/transaksi.blade.php ENDPATH**/ ?>