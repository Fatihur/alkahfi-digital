...
<body>
    ...
    <style>
        ...
        .login-left { flex: 1; background: url('<?php echo e(asset('loginbg.jpg')); ?>') center/cover no-repeat; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 40px; color: white; position: relative; }
