...
class TagihanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('bendahara.tagihan.create', compact('santriList', 'kelasList', 'angkatanList', 'kategoriList'));
    }
    ...
    {
        $kategoriList = KategoriTagihan::where('is_active', true)->get();
        return view('bendahara.tagihan.edit', compact('tagihan', 'kategoriList'));
    }
